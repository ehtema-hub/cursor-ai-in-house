...
from app.blueprints.orders import blp as orders_blp
from app.blueprints.products import blp as products_blp
...
def register_blueprints(smorest_api) -> None:
    ...
    smorest_api.register_blueprint(products_blp)
    smorest_api.register_blueprint(orders_blp)
